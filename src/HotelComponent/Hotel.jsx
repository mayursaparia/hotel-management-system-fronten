    ...
    <div className="container-fluid mb-5">
      <div class="row">
        ...
        <div class="col-sm-5 mt-2">
          <div class="card form-card border-color custom-bg">
            <div class="card-header bg-color" style={{ "border-radius": "1em 1em 0em 0em" }}>
                ...
                <form class="row g-3" onSubmit={bookHotel}>
                  ...
                  <div className="d-flex justify-content-center">
                    <div>
                      <input
                        type="submit"
                        class="btn custom-bg bg-color custom-bg-text mb-3"
                        value="Book Hotel"
                      />
                    </div>
                  </div>
                ...
                if (admin) {
                  ...
                  return (
                    <div>
                      <input
                        type="submit"
                        className="btn custom-bg bg-color custom-bg-text mb-3"
