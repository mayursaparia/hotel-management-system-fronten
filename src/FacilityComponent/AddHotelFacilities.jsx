    ...
    <div>
      <div className="mt-2 d-flex aligns-items-center justify-content-center">
        <div
          ...
          style={{ width: "45rem" }}
        >
          <div className="card-header bg-color text-center custom-bg-text" style={{ "border-radius": "1em 1em 0em 0em" }}>
                  ...
                  {hoteFacilities.map((f) => {
                    return (
                      <tr>
                        ...
                        <td>
                          <button
                            className="btn bg-color custom-bg custom-bg-text btn-sm"
